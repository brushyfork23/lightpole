...
CRGB leds[NUM_LEDS];
Metro drawNextFrame;
uint16_t vols[NUM_LEDS]; // volume for each leds, updated once per frame
uint8_t index = 0; // index of vols
uint8_t hue = 0;
...
uint16_t vol=0; // last read volume
